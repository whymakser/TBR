...
void SBone::Snap(int SnappingClient, CEntity* followParent) const // option to draw bones without parents is possible but rn this gud \^-^/
{
...
void STrail::Snap(CEntity* followParent) const
{
	auto Server = followParent->Server();
