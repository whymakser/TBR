...
MACRO_CONFIG_INT(SvMoneyBankMode, sv_money_bank_mode, 1, 0, 2, CFGFLAG_SERVER|CFGFLAG_GAME, "Bank mode (0=no bank , 1=normal bank, 2=instant deposit from farm)", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvJoinMsgDelay, sv_join_msg_delay, 0, 0, 60, CFGFLAG_SERVER, "The time in seconds the player join message get's delayed (and sv_chat_initial_delay is imitated)", AUTHED_ADMIN)
