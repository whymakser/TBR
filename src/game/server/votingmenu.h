...
class CVotingMenu
{
	...
	enum
	{
		...
		// VIP
		PREVFLAG_ACC_VIP_RAINBOW = 1 << 5,
		PREVFLAG_ACC_VIP_BLOODY = 1 << 6,
		PREVFLAG_ACC_VIP_ATOM = 1 << 7,
		PREVFLAG_ACC_VIP_TRAIL = 1 << 8,
		PREVFLAG_ACC_VIP_SPREADGUN = 1 << 9,
		// VIP Plus
		PREVFLAG_ACC_VIP_PLUS_RAINBOWHOOK = 1 << 10,
		PREVFLAG_ACC_VIP_PLUS_ROTATINGBALL = 1 << 11,
		PREVFLAG_ACC_VIP_PLUS_EPICCIRCLE = 1 << 12,
		PREVFLAG_ACC_VIP_PLUS_LOVELY = 1 << 13,
		PREVFLAG_ACC_VIP_PLUS_RAINBOWNAME = 1 << 14,
		// Acc Misc
		PREVFLAG_ACC_MISC_SILENTFARM = 1 << 15,
