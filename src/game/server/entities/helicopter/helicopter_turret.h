...
protected:
    ...
    // Generating
    [[nodiscard]] vec2 GetTurretDirection() const;
...
public:
    ...
    [[nodiscard]] int GetType() const { return m_TurretType; }
    [[nodiscard]] size_t GetNumBones() const { return m_NumBones; }
...
private:
    ...
    static constexpr float AngleDiff() { return 2.f * pi / NUM_BONES_CLUSTER; } // 360deg / 3 = 120deg per bone
