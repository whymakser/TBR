...
MACRO_CONFIG_INT(SvPoliceFarmLimit, sv_police_farm_limit, 1, 0, 1, CFGFLAG_SERVER|CFGFLAG_GAME, "Whether police farm tiles are limited to a dynamic number of players", AUTHED_ADMIN)
